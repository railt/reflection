 ...
 */
class DirectiveInheritanceTestCase extends InstanceInheritanceTestCase
{
    /**
     * @return array
    ...
    public function inheritanceDataProvider(): array
    {
        ...
        $target = new DirectiveDefinition($document, 'SourceType');

        return [
            Type::DIRECTIVE    => [$target, new DirectiveDefinition($document, 'ChildType'), true],
