...
class InputUnionInheritanceTestCase extends TypeInheritanceTestCase
{
    ...
    {
        return [
            'Is a type of ' . Type::DIRECTIVE    => [Type::INPUT_UNION, Type::DIRECTIVE, true],
            ...
            'Is a type of ' . Type::INPUT_UNION  => [Type::INPUT_UNION, Type::INPUT_UNION, false],
            ...
            'Is a type of ' . Type::UNION        => [Type::INPUT_UNION, Type::UNION, false],
